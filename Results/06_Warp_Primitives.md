...
--- CPU 计时 (计算所有版本) ---
CPU Broadcast 执行时间：   29.54 ms
CPU XOR       执行时间：   40.59 ms
CPU Up/Down   执行时间：   48.86 ms
CPU Reduce    执行时间：   41.00 ms
...
--- 性能分析 ---
CPU vs Broadcast Kernel 加速比：101.58x
CPU vs Reduce Sum Kernel 加速比：276.09x
Warp Broadcast 有效带宽：923.14 GB/s
Warp Reduce Sum 有效带宽：932.06 GB/s
(RTX 4090 理论峰值：~1008 GB/s)

--- Kernel 性能对比 ---
Warp Broadcast:    0.2908 ms (基准)
XOR Shuffle:       0.2908 ms (1.00x)
Up/Down Shuffle:     0.30 ms (0.98x)
Warp Reduce Sum:     0.15 ms (高度内存密集与运算)
...
--- CPU 计时 ---
CPU Reduce Sum 执行时间：   48.87 ms
CPU Reduce Max 执行时间：   50.45 ms
...
--- 性能分析 ---
CPU vs Reduce Sum 加速比：340.14x
CPU vs Reduce Max 加速比：351.17x
Reduce Sum 有效带宽：937.89 GB/s
Reduce Max 有效带宽：937.89 GB/s
(RTX 4090 理论峰值：~1008 GB/s)
...
--- CPU 计时 ---
CPU Inclusive Scan 执行时间：   51.61 ms
CPU Exclusive Scan 执行时间：   51.59 ms
...
--- 性能分析 ---
CPU vs Inclusive Scan 加速比：170.02x
CPU vs Exclusive Scan 加速比：170.00x
Inclusive Scan 有效带宽：884.34 GB/s
Exclusive Scan 有效带宽：884.58 GB/s
(RTX 4090 理论峰值：~1008 GB/s)
