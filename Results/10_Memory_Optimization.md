...
Stride = 32 (32-way冲突):     0.01 ms (2.26x)

--- 性能与带宽分析 ---
无冲突带宽：  876.03 GB/s
有冲突带宽：  729.68 GB/s
Padding带宽：  819.73 GB/s
(RTX 4090 理论峰值：~1008 GB/s)

--- Kernel 性能对比 ---
无冲突(基准):     0.1532 ms
有冲突(未优化):   0.1839 ms (1.20x 变慢)
...
--- 性能分析与带宽利用率 ---
同步拷贝     有效带宽：  899.96 GB/s
单阶异步     有效带宽：  899.04 GB/s
多阶流水线   有效带宽：  857.38 GB/s
(RTX 4090 理论峰值：~1008 GB/s)
...
--- 性能分析与带宽利用率 ---
合并访问    有效带宽：  924.82 GB/s
跨步访问(2) 有效带宽：  427.03 GB/s
AoS 访问    有效带宽：  922.28 GB/s
SoA 访问    有效带宽：  912.85 GB/s
(RTX 4090 理论峰值：~1008 GB/s)
