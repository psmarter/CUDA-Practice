...
--- 性能分析 ---
CPU vs Warp Reduce GPU 加速比：323.17x
Naive GPU 有效带宽：        647.08 GB/s
Welford GPU 有效带宽：      699.20 GB/s
Warp Reduce GPU 有效带宽：  544.59 GB/s
Warp-per-row GPU 有效带宽：111.27 GB/s
(RTX 4090 理论峰值：~1008 GB/s)

--- Kernel 性能对比 ---
Naive LayerNorm:          0.0065 ms (基准)
Welford LayerNorm:        0.0060 ms (1.08x)
...
--- 性能分析 ---
CPU vs Warp Reduce GPU 加速比：830.03x
Naive GPU 有效带宽：        800.00 GB/s
Warp Reduce GPU 有效带宽：  1201.72 GB/s
Warp-per-row GPU 有效带宽：119.81 GB/s
(RTX 4090 理论峰值：~1008 GB/s)

--- Kernel 性能对比 ---
Naive Softmax:          0.0052 ms (基准)
Online Softmax:         0.0040 ms (1.30x)
...
--- 带宽分析 ---
Naive 有效带宽：212.57 GB/s
Warp  有效带宽：2613.72 GB/s
...
--- 带宽分析 ---
Naive 有效带宽：  1678.80 GB/s
Vector 有效带宽： 1733.70 GB/s
...
H2D 传输时间：       1.20 ms
Kernel 执行时间：    5.32 ms (50 次平均)
D2H 传输时间：       0.45 ms
GPU 总时间：         6.97 ms

--- 性能分析 ---
CPU vs Flash V3 加速比：1280.07x
Naive GPU 有效推断带宽：2.52 GB/s
Flash V1  有效推断带宽：1.75 GB/s
Flash V3  有效推断带宽：3.15 GB/s
(RTX 4090 理论峰值：~1008 GB/s)

--- Kernel 性能对比 ---
Naive Attention (3 Steps):   6.6585 ms (基准)
Flash Attention V1:          9.5814 ms (0.69x)
Flash Attention V3:            5.32 ms (1.25x)
