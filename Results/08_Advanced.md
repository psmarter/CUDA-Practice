...
--- GPU 版本 1: 传统单流 (完全串行) ---
Pipeline 周期时间：   15.56 ms (10 次平均)

--- GPU 版本 2: 多流 (流水线并发) ---
Pipeline 周期时间：   13.72 ms (10 次平均)

--- 性能分析 ---
CPU vs GPU (多流) 总加速比：13.98x
单流 vs 多流 并发加速比：   1.13x
GPU 有效流水线吞吐带宽：14.67 GB/s
(RTX 4090 理论峰值：~1008 GB/s)

--- Kernel 性能对比 ---
传统单流:  15.5562 ms (基准)
多流并发:    13.7241 ms (1.13x 并发开销减免)
...
--- CPU 计时 ---
Forward CPU 执行时间：      30.27 ms
Backward CPU 执行时间：     45.60 ms

--- GPU 版本: Custom Swish ---
[Forward] H2D 传输时间：     4.03 ms
[Forward] Kernel 时间：      0.08 ms (100 次平均)
[Forward] D2H 传输时间：     4.04 ms
[Backward] H2D 传输时间：    7.94 ms
[Backward] Kernel 时间：     0.13 ms (100 次平均)
[Backward] D2H 传输时间：    4.03 ms

--- 性能分析 ---
[Forward] CPU vs GPU Kernel 加速比：370.01x
[Backward] CPU vs GPU Kernel 加速比：338.92x
GPU Forward 有效带宽：1025.54 GB/s
GPU Backward 有效带宽：935.26 GB/s
(RTX 4090 理论峰值：~1008 GB/s)
...
--- 性能分析 ---
CPU vs GPU (Graph) Kernel 加速比：40.52x
CPU vs GPU (Graph) 总时间加速比：0.70x
GPU 有效带宽：858.16 GB/s
(RTX 4090 理论峰值：~1008 GB/s)

--- Kernel 性能对比 ---
Multi-Stream Launch:   0.0050 ms (基准)
CUDA Graph Launch:     0.0042 ms (1.20x CPU 发射开销减免)
