...
> **Warp Lane 活跃状态（以 8 Lane 示意 stride 效果，✅ = 活跃，⬛ = 空转）**：
>
> | stride | L0 | L1 | L2 | L3 | L4 | L5 | L6 | L7 | 32线程 Warp 利用率 |
> | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
> | 1 | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | 100% |
> | 2 | ✅ | ⬛ | ✅ | ⬛ | ✅ | ⬛ | ✅ | ⬛ | 50% |
> | 4 | ✅ | ⬛ | ⬛ | ⬛ | ✅ | ⬛ | ⬛ | ⬛ | 25% |
...
> | **16** | **✅** | ⬛ | ⬛ | ⬛ | ⬛ | ⬛ | ⬛ | ⬛ | **6.25%** |
>
> 在真实的 32 线程 Warp 中，当 `stride=16` 时只有 Lane 0 和 Lane 16 活跃——硬件利用率仅 **6.25%**，SM 内 Tensor Core 和 FP32 Core 的绝大部分算力被闲置。这是 Naive 树形归约在 GPU 上的根本性能瓶颈。
